...
class KeysInfo extends React.Component {
...
class Tbl_struct extends React.Component {
        ...
        return (
          <div>
              <table>
                  ...
                  <tr>
                      <td valign="top">
                          <form action={this.props.addTableUrl} method="post" name="formTableStructure"
                              ...
                              <div className="imageAction">
                                  <u>Выбранные</u>
                                  <input type="image" src={this.props.dirImage + "edit.gif"}
                                         onClick={msImageAction.bind(this, 'fieldsEdit')} alt=""/>
                                  <input type="image" src={this.props.dirImage + "close.png"}
              ...
              {this.props.dataKeys.length ? <KeysInfo {...this.props} /> : <a href={this.props.showKeysUrl}>Показать информацию о ключах</a>}

              <p><a href={this.props.addKeyUrl}>Добавить ключ</a></p>

              <textarea className="wide" defaultValue={this.props.sqlCreateTable}></textarea>
          </div>
        );
    }
}